...
ESPRotary::~ESPRotary()
{
  pinManager.deallocatePin(pin1, PinOwner::UM_BedlightDoubleRotaryEncoder);
  pinManager.deallocatePin(pin2, PinOwner::UM_BedlightDoubleRotaryEncoder);
}
...
{
  if (!pinManager.allocatePin(pin1, false, PinOwner::UM_BedlightDoubleRotaryEncoder) ||
      !pinManager.allocatePin(pin2, false, PinOwner::UM_BedlightDoubleRotaryEncoder))
  {
    Serial.println("Could not allocate pin for ESPRotary.");
    return;
  }
